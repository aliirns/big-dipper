...
import { FCMToken } from "../../api/fcmtoken/fcmtoken";
...
MissedBlocks.rawCollection().createIndex(
  { voter: 1, proposer: 1, blockHeight: -1 },
  { unique: true }
);
...
Validators.rawCollection().createIndex(
  ...
  {
    unique: true,
    partialFilterExpression: { "consensusPubkey.value": { $exists: true } },
  }
);
