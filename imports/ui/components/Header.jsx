    ...
    render() {
        ...
        return (
            <Navbar color="primary" dark expand="lg" fixed="top" id="header">
                <NavbarBrand tag={Link} to="/" onClick={() => window.location = "/"}><img src="/img/big-dipper-icon-light.svg" className="img-fluid logo"/> <span className="d-none d-xl-inline-block"><T>navbar.siteName</T>&nbsp;</span><Badge color="secondary">{this.state.version}</Badge> </NavbarBrand>
                ...
                <Collapse isOpen={this.state.isOpen} navbar>
                    <Nav className="ml-auto text-nowrap" navbar>
                        ...
                        <NavItem>
                            <NavLink tag={Link} to="/art_sales"><T>navbar.art_sales</T></NavLink>
                        </NavItem>
                        <NavItem>
