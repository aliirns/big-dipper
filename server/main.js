...
sendUnsettledNotifications = () => {
  Meteor.call("Notifications.sendPushNotifications", (error, result) => {
    if (error) {
      console.log("Unable to Send Notifications", error);
    } else {
      console.log("Notifications were sent to FCM ", result);
    }
  });
};
